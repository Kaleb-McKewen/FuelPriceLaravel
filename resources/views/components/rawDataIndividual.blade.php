    ...
    <div class="flex flex-col mx-8">
        <div class="min-md:absolute min-md:left-10 block m-4">
            <a class="text-white bg-blue-600 hover:bg-blue-700 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2"
                href="{{ url()->previous('/raw') }}">Go Back</a></div>
        ...
        <div class="flex flex-col justify-center mb-4 items-center">
            <h2 class="text-2xl font-medium mb-12">The average price was $<u>{{ $fuelprice->average }}</u></h2>
            <h2 class="text-2xl font-medium underline mb-4">The Lowest 95 stations on {{ $fuelprice->time }} were:</h2>
